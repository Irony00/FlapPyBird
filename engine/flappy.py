...
class FlappyBird:
    ...
    def __init__(self, controller_queue, status_queue):
    ...
    def mainGame(self, movementInfo):
        ...
        self.playerx, self.playery = int(SCREENWIDTH * 0.2), movementInfo['self.playery']
        ...
        while True:
            ...
            controls = self.controller_queue.get()
            if controls == self.JUMP:
            ...
            crashTest = self._checkCrash({'x': self.playerx, 'y': self.playery, 'index': playerIndex},
